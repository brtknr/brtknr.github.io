...
![png]({{site.url}}/images/uniform.modulus/Notebook_9_0.png)



    <matplotlib.figure.Figure at 0x1a0ae26160>
...
![png]({{site.url}}/images/uniform.modulus/Notebook_13_0.png)



    <matplotlib.figure.Figure at 0x1a13e85e10>
...
```
    ...
    [NbConvertApp] Support files will be in {{site.url}}/images/uniform.modulus/
    [NbConvertApp] Making directory {{site.url}}/images/uniform.modulus
    [NbConvertApp] Making directory {{site.url}}/images/uniform.modulus
    [NbConvertApp] Writing 3915 bytes to Notebook.md
